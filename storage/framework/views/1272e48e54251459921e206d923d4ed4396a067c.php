...
<section class="content-header">
    <h1><?php echo app('translator')->get('game_list.add_game'); ?></h1>
</section>

<!-- Main content -->
<section class="content">
	<?php echo Form::open(['url' => action('GameListController@store'), 'method' => 'post', 'id' => 'add_promotion_form', 'files' => true ]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Freelancing_Projects\09-erp system minor modification(laravel)\source\ftmainlah\resources\views/game_list/create.blade.php ENDPATH**/ ?>