<?php $__env->startSection('title', __('notice.edit_notice')); ?>

<?php $__env->startSection('content'); ?>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1><?php echo app('translator')->get('notice.edit_notice'); ?></h1>
</section>

<!-- Main content -->
<section class="content">
  <?php echo Form::open(['url' => action('NoticeController@update', [$id]), 'method' => 'PUT', 'id' => 'add_notice_form', 'files' => true ]); ?>

  <div class="box box-solid">
    <div class="box-body">
      <button class="btn btn-success" id="new_tab">New Tab</button>
      <input id="promotion_id" value="<?php echo e($id, false); ?>" hidden>
      <input id="form_cnt" value="<?php echo e(count($notices), false); ?>" hidden>
      <div id="exTab2">
        <ul class="nav nav-tabs">
          <?php $__currentLoopData = $notices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($key == 0): ?>
              <li class="active">
                <a href="#tab0" data-toggle="tab">(Default)<?php echo e($notice['lang'], false); ?></a>
              </li>
            <?php else: ?>
              <li>
                <a href="#tab<?php echo e($key, false); ?>" data-toggle="tab"><?php echo e($notice['lang'], false); ?></a>
              </li>
            <?php endif; ?>
          ...
          <?php $__currentLoopData = $notices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($key == 0): ?>
              <div class="tab-pane active" id="tab0">
                <?php echo $__env->make('notice.form', ['form_index' => 0, 'notice' => $notice, 'promotion_langs' => $promotion_langs], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
              </div>
            <?php else: ?>
              <div class="tab-pane" id="tab<?php echo e($key, false); ?>">
                <?php echo $__env->make('notice.form', ['form_index' => $key, 'notice' => $notice, 'promotion_langs' => $promotion_langs], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
              </div>
            <?php endif; ?>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Freelancing_Projects\09-erp system minor modification(laravel)\source\ftmainlah\resources\views/notice/edit.blade.php ENDPATH**/ ?>