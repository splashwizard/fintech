...
<section class="content-header no-print">
    <h1><?php echo app('translator')->get('new_transaction.label'); ?>
        <small></small>
    </h1>
</section>
                ...
                <?php if(auth()->user()->can('direct_sell.access') ||  auth()->user()->can('view_own_sell_only')): ?>
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped ajax_view" id="deposit_table">
                            <thead>
                                <tr>
                                    <th style="width:85px"><?php echo app('translator')->get('messages.date'); ?></th>
                                    <th><?php echo app('translator')->get('new_transaction.request_number'); ?></th>
                                    <th><?php echo app('translator')->get('new_transaction.contact_id'); ?></th>
                                    <th><?php echo app('translator')->get('new_transaction.bank'); ?></th>
                                    <th><?php echo app('translator')->get('new_transaction.deposit_method'); ?></th>
                                    <th><?php echo app('translator')->get('new_transaction.amount'); ?></th>
                                    <th><?php echo app('translator')->get('new_transaction.reference_number'); ?></th>
                                    <th><?php echo app('translator')->get('new_transaction.product_name'); ?></th>
                                    <th><?php echo app('translator')->get('new_transaction.bonus'); ?></th>
                                    <th><?php echo app('translator')->get('new_transaction.view_receipt'); ?></th>
                                    <th style="width:110px"><?php echo app('translator')->get('new_transaction.action'); ?></th>
                                    <th><?php echo app('translator')->get('new_transaction.status'); ?></th>
                                </tr>
                            </thead>
                            <tfoot>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped ajax_view" id="withdraw_table" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('new_transaction.amount'); ?></th>
                                <th><?php echo app('translator')->get('new_transaction.product_name'); ?></th>
                                <th><?php echo app('translator')->get('new_transaction.remark'); ?></th>
                                <th style="width:110px"><?php echo app('translator')->get('new_transaction.action'); ?></th>
                                <th><?php echo app('translator')->get('new_transaction.status'); ?></th>
                            </tr>
                            </thead>
            ...
            <div class="tab-pane" id="transfer_tab">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped ajax_view" id="withdraw_table" style="width: 100%;">
                        <thead>
                            <tr>
                                <th style="width:135px"><?php echo app('translator')->get('messages.date'); ?></th>
                                <th><?php echo app('translator')->get('new_transaction.request_number'); ?></th>
                                <th><?php echo app('translator')->get('new_transaction.contact_id'); ?></th>
                                <th><?php echo app('translator')->get('new_transaction.from_game'); ?></th>
                                <th><?php echo app('translator')->get('new_transaction.to_game'); ?></th>
                                <th><?php echo app('translator')->get('new_transaction.amount'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Freelancing_Projects\09-erp system minor modification(laravel)\source\ftmainlah\resources\views/newtransaction/index.blade.php ENDPATH**/ ?>