...
//    Route::get('/mass_overview', 'MassOverviewController@index')->name('mass_overview');
    ...
    Route::get('/contacts/customersWithId', 'ContactController@getCustomersWithId');
    ...
    Route::get('/sells/pos_deposit/get_update_pos_row/{transaction_id}', 'SellPosDepositController@getUpdatePosRow');
    Route::get('/sells/pos_deposit/get_update_pos_data/{transaction_id}', 'SellPosDepositController@getUpdatePosData');
...
//    Route::get('/users/vincent', 'ManageUserController@setVincent');
    ...
    Route::post('/dashboard_deposit/update_bonus_description/{id}', 'DashboardDepositController@updateBonusDescription');
