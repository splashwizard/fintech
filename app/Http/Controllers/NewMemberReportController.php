...
class NewMemberReportController extends Controller
{
...
//        print_r(json_decode(Contact::find(126)->bank_details));exit;
    ...
    private function indexCustomer()
    {
        ...
        $query->addSelect(['contacts.contact_id', 'contacts.name', 'contacts.email', 'contacts.created_at', 'contacts.remarks1', 'contacts.remarks2', 'contacts.remarks3', 'contacts.created_by',
...
//                    $result .= $detail->bank_brand_id.": ".$detail->account_number."<br/>";
            ...
            ->editColumn('created_by', function ($row){
                $result = User::find($row->created_by)->username;
                return $result;
            })
