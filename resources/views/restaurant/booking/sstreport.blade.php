...
<table style="width:100%">
 ...
 <td>
        ...
        href="/fpdi/print/pdf/sstp1.php?id=16" target="_blank"><i class="fa fa-print"></i> Print Page 1</a>
        <div class="col-sm-12">
        </div>
            ...
            aria-label="Print" 
            onclick=" window.open('/fpdi/print/pdf/sstp2.php','_blank')"
    ...
    <td><p> {{ $booking->tax_number_1 }} <button type="button" class="btn btn-success" onclick=" window.open('/business/settings','_blank')"> Edit</button></p>  </td>
...
<table style="width:100%">
  <tr>
    ...
    <th>Nilai Barang kena cukai(System Calculated)</th>
    <th>
    </th>
  </tr>
