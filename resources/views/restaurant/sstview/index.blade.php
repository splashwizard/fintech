            ...
            @can('restaurant.create')
            	<div class="box-tools">
                    <button type="button" class="btn btn-block btn-primary btn-modal" 
                    	data-href="{{action('Restaurant\SstviewController@create')}}" 
        ...
        $(document).ready(function(){
            ...
            var tables_table = $('#tables_table').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'tax_label_1', name: 'business.tax_label_1'},
                        { data: 'tax_number_1', name: 'business.tax_number_1'},
