				...
				<div class="tab-content">
					<div class="tab-pane active" id="1">
						<div class="box-body">
							...
							<input type='file' class="hidden" id="mobile_imageUpload" name="mobile_imageUpload" accept="image/*"/>
							<div class="image-preview form-group" style="display: none">
								<div id="mobile_imagePreview" style="background-image: url(http://i.pravatar.cc/500?img=7);">
								</div>
							</div>
							<div class="margin-bottom-xs">
								<button class="btn" style="background-color: #000000;color: white" id="btn_mobile_upload"> Upload Image <i class="fa fa-upload"></i></button>
								<button class="btn btn-danger" id="btn_mobile_remove"> Remove Image <i class="fa fa-remove"></i></button>
							</div>
