...
<section class="content-header">
    <h1>@lang('promotion.promotions')</h1>
</section>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-primary', 'title' => __('promotion.all_promotions')])
                @can('expenses')
                    @slot('tool')
                        <div class="box-tools">
                            <a class="btn btn-block btn-primary" href="{{action('PromotionController@create')}}">
                            <i class="fa fa-plus"></i> @lang('messages.add') Promotion</a>
                        </div>
                    @endslot
...
@stop
@section('javascript')
 <script src="{{ asset('js/promotion.js?v=' . $asset_v) }}"></script>
@endsection