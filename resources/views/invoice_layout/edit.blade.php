  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        @endif
        @if(empty($invoice_layout->is_order_confirm))
        <div class="col-sm-3">
          <div class="form-group">
            <br>
            <div class="checkbox">
              <label>
                {!! Form::checkbox('is_order_confirm', 1, $invoice_layout->is_order_confirm, ['class' => 'input-icheck']); !!} @lang('barcode.set_as_order_confirm')</label>
            </div>
          </div>
        </div>
        @endif
